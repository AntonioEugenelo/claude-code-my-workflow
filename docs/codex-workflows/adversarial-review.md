...
When the Codex client supports repo-local hooks, this workflow also has hook-backed enforcement for active review completeness and unresolved reviewer-conflict state via `.codex/hooks.json`.
