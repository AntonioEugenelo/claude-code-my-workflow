...
- **Follow R code conventions** in `.agent/rules/r-code-conventions.md`
...
- **Use project theme** for all figures (check for custom theme in `.agent/rules/`)
...
1. Read `.agent/rules/r-code-conventions.md` for project standards
