...
2. **Read `.agent/rules/r-code-conventions.md`** for the current standards
...
- [ ] Check `.agent/rules/r-code-conventions.md` for known pitfalls
...
5. **Check Known Pitfalls.** See `.agent/rules/r-code-conventions.md` for project-specific bugs.
