...
- **Follow R code conventions** in `.Codex/rules/r-code-conventions.md`
...
- **Use project theme** for all figures (check for custom theme in `.Codex/rules/`)
...
1. Read `.Codex/rules/r-code-conventions.md` for project standards
