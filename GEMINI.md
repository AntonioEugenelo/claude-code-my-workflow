# GEMINI.MD -- Academic Project Development with Antigravity

<!-- HOW TO USE: Replace [BRACKETED PLACEHOLDERS] with your project info.
     Customize Beamer environments and CSS classes for your theme.
     Keep this file under ~150 lines — Antigravity loads it every session.
...
├── GEMINI.MD                    # This file (Antigravity project config)
├── MEMORY.md                    # Persistent learning log
├── .agent/                      # Rules, skills, workflows
│   ├── rules/                   # Behaviour rules (always-on + path-scoped)
│   ├── skills/                  # Reusable skill instructions
│   └── workflows/               # Review/agent workflows
