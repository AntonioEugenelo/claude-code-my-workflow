...
| **Fiscal-LPT paper** | `../Fiscal-LPT/**/*.tex`, `Fiscal-LPT/**/*.tex` | proofreader ∥ derivation-auditor¹ ∥ figure-reviewer¹ → theory-critic → cochrane-style-reviewer → narrative-reviewer | Deep |
